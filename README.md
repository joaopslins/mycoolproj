...
- [ ] Add an email address to the `ADMINS` settings variable in `mycoolproj/mycoolproj/settings/base.py`
- [ ] Change the `SERVER_EMAIL` to the email address used to send e-mails in `mycoolproj/mycoolproj/settings/production.py`
...
- Create a copy of ``mycoolproj/settings/local.py.example``:  
  `cp mycoolproj/settings/local.py.example mycoolproj/settings/local.py`
